...
/***/ function(module, exports, __webpack_require__) {
	...
	var currentGame = __webpack_require__(9);
	...
	var onUpdateGame = function onUpdateGame() {
	  api.updateGame().done(ui.updateGameSuccess).fail(ui.updateGameFailure);
	};

	var onFinishedGames = function onFinishedGames() {
	  event.preventDefault();
	  api.getGames().done(ui.getGameSuccess).fail(ui.getGameFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "10133673ea3e43dc2d9c891a5dc0f49e.png";
